...
alpha_for_plots <- 0.05
drop_flagged_fits <- TRUE
...
dat_s1 <- make_scenario_list_from_combined(
  dat_all = dat_all,
  scenario_value = scenario_1_id,
  n_order = n_order_by_file
)

dat_s2 <- make_scenario_list_from_combined(
  dat_all = dat_all,
  scenario_value = scenario_2_id,
  n_order = n_order_by_file
)

dat_s3 <- make_scenario_list_from_combined(
  dat_all = dat_all,
  scenario_value = scenario_3_id,
  n_order = n_order_by_file
)

dat_s4 <- make_scenario_list_from_combined(
  dat_all = dat_all,
  scenario_value = scenario_4_id,
  n_order = n_order_by_file
)
...
perf_s1 <- plot_performance_effects_3x4(
  dat_list = dat_s1,
  effects = effects_for_plots,
  n_order = n_order_for_plots,
  n_labels = n_labels_for_plots,
  occasions = occasions_for_plots,
  alpha = alpha_for_plots,
  drop_flagged = drop_flagged_fits,
  width = plot_width,
  height = plot_height,
  include_mcse_bars = include_mcse_bars,
  keep_model_names = keep_model_names_for_plots,
  method_order = method_order_for_plots
)

perf_s2 <- plot_performance_effects_3x4(
  dat_list = dat_s2,
  effects = effects_for_plots,
  n_order = n_order_for_plots,
  n_labels = n_labels_for_plots,
...
perf_s3 <- plot_performance_effects_3x4(
  dat_list = dat_s3,
  effects = effects_for_plots,
  n_order = n_order_for_plots,
  n_labels = n_labels_for_plots,
...
perf_s4 <- plot_performance_effects_3x4(
  dat_list = dat_s4,
  effects = effects_for_plots,
  n_order = n_order_for_plots,
  n_labels = n_labels_for_plots,
...
plot_s3 <- perf_s3$plots[[effects_for_plots[1]]]
