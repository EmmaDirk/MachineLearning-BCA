...
# - RI-CLPM with indirect confounder adjustment via random intercepts where the RI loadings are freely estimated across time-points
# - DPM
# - DPM where the loadings of the accumulating facotrs (latent factors) are freely estimated across time-points
...
# same as above but for RI-CLPM with freely estimated RI loadings
safe_fit_riclpm_free_RI_loadings <- function(model_string, data) {
...
# same as above but for DPM with freely estimated accumulating factor loadings
