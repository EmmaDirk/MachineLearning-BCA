...
source(here("01_scripts", "02_development", "01_study_1_RR", "00_packages.R"))

# step 1: sample a delta-matrix
# get the function to sample the delta-matrix
source(here("01_scripts", "02_development", "01_study_1_RR", "01_delta_sampler.R"))
...
source(here("01_scripts", "02_development", "01_study_1_RR", "02_delta_trajectory.R"))
...
source(here("01_scripts", "02_development", "01_study_1_RR", "03_simulate_panel_data.R"))
source(here("01_scripts", "02_development", "01_study_1_RR", "04_lavaan_model_string_builder.R"))
source(here("01_scripts", "02_development", "01_study_1_RR", "05_linear_residualiser.R"))
source(here("01_scripts", "02_development", "01_study_1_RR", "06_model_fitters.R"))
source(here("01_scripts", "02_development", "01_study_1_RR", "07_fit_stat_extractors.R"))
source(here("01_scripts", "02_development", "01_study_1_RR", "08_one_replication_wrapper.R"))

# step 6: run the simulation study function
# get the function to run the full simulation study
source(here("01_scripts", "02_development", "01_study_1_RR", "09_simulation_function.R"))
...
source(here("01_scripts", "02_development", "01_study_1_RR", "10_plotting.R"))
