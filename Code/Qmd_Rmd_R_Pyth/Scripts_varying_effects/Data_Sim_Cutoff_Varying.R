...
# (set gamma_y_cut <- rep(0, k_lin) if only X should plateau)
...
# cache data if desired
write.csv(df, file = "Thesis/Code/Data/Data_Sim_plateau_Blist_Pop.csv", row.names = FALSE)
